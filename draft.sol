...
import "@openzeppelin/contracts/utils/Strings.sol"; // Ensure Strings library is imported
import "@chainlink/contracts/src/v0.8/interfaces/AggregatorV3Interface.sol";
import "SportNFT.sol" as SportNFT; // Ensure this path is correct according to your project structure
...
contract SportVault is Ownable, ReentrancyGuard {
    ...
    constructor(address _token, address _sportNftAddress, address _priceFeed) Ownable() {
        ERCtoken = _token;
